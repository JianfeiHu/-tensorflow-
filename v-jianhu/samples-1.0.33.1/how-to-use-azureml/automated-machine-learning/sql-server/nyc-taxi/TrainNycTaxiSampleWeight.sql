...
--
-- This call uses @sample_weight_column to give more weight to the less frequent classes.
...
SELECT TOP 100000
      ...
      ,[payment_type]
      ,[tip_class]
	  ,CAST((CASE [tip_class] WHEN 3 THEN 0.1 WHEN 4 THEN 1.0 ELSE 0.0001 END) AS FLOAT) AS sample_weight
